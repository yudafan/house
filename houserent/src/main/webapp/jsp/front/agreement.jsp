            ...
            <div class="col-lg-12 col-md-12">
                <div class="property_block_wrap style-2">
                    <div id="content" style="...">
                        ...
                        <p>2、该房屋及所属设施的维修责任除双方在本合同及补充条款中约定外，均由甲方负责（但乙方使用不当除外）。甲方进行维修须提前天通知乙方，乙方应积极协助配合。</p>
                        <p>
                            3、乙方因使用需要，在不影响房屋结构的前提下，可以对房屋进行装修装饰，但其设计规模、范围、工艺、用料等方案应事先征得甲方的同意后方可施工。租赁期满后，依附于房屋的装、房屋的转让与转</p>
                        <p>四、房屋的转让与转租</p>
                        <p>1、租赁期间，未经甲方书面同意，乙方不得擅自转租、转借承租房屋。</p>
                        <p>2、甲方同意乙方转租房屋的，应当单独订立补充协议，乙方应当依据与甲方的书面协议转租房屋。</p>
                        <p>五、乙方违约的处理规</p>
                        <p>
                            在租赁期内，乙方有下列行为之一的，甲方有权终止合同，收回该房屋，乙方应向甲方支付合同总租金20％的违约金，若支付的违约金不足弥补甲方损失的，乙方还应负责赔偿直至达到弥</p>
                    ...
                    <div style="...">
                        <%--订单状态：-2待签合同，-1付款，0生效中，1已判期，-3已取消，2申请退租，3申请退租不通过--%>
                        <c:choose>
                            <c:when test="${order.status ==-2}">
                                <a href="javascript:void(0)" onclick="confirmAgreement (${order.id})"
                                   class="btn btn-primary">我已阅读并同意意上述合同</a>
                            </c:when>
...
<script>
    function printHtml(div){
        var befor="<html><head><meta http-equiv='Content-Type' content='text/html;charset=utf-8'></head><body>";
        var print=document.getElementById(div).innerHTML;
        var result=befor+print+"</body></html>"
