            ...
            <div class="col-lg-8 col-md-12">
                <div class="property_block_wrap style-2">
                    <div data-toggle="collapse" href="#clOne" class="property_block_wrap_header">
                        <h4 class="property_block_title">房子详情</h4>
                    </div>
                        ...
                        <div class="block-body">
                            <ul class="deatil_features">
                                ...
                                <li>
                                    ...
                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${LocalDate.parse(house.lastOrdeerStartTime)}"/>
                                </li>
                                <li>
                                    <strong>最后一次入住结束时间：</strong>
                                    <fmt:formatDate pattern="yyyy-MM-dd" value="${LocalDate.parse(house.lastOrderEndTime)}"/>
                                </li>
                        ...
                        <div class="side-block-body">
                            <form id="contactForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
                                            <textarea type="text" class="form-control" name="content" placeholder="想要发送的信息内容"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
