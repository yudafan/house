...
<%@ include file="../common/head.jsp"%>
    <div class="image-cover hero_banner" style="background: #334aca url('/assets/img/banner-5.jpg') no-repeat;" data-overlay="1">
        <div class="container">
            <h1 class="big-header-capt mb-0">要开启一段烂漫的租房之旅了呢！</h1>
            <p class="text-center mb-5">搜索你所在城市的小区或房屋类型吧！</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        <select id="price" name="priceRange"  class="form-control">
                                            ...
                                            <option value="13000;19999">13000-19999</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
