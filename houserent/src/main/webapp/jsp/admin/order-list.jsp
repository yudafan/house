                                ...
                                <tr>
                                    <td class="dashboard_propert_wrapper">
                                        ...
                                        <div class="title">
                                            ...
                                            总金额：￥${c.totalAmount}
                                                ...
                                                <%--订单状态：-3租客已取消，-2待签合同，-1待付款0生效中，1已到期，2退租申请，3退租申请不通过--%>
                                            <c:choose>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${c.status==2&&(sessionScope.user.role=='admin'||sessionScope.user.role=='owner')}">
                                            <a href="javascript:void(0)" onclick="endOrderPass(${c.id})">申请退租通过</a><br/>
                                            <a href="javascript:void(0)" onclick="endOrderReject(${c.id})">申请退租不通过</a>
                                        </c:if>
                                    </td>
                                </tr>
                            </c:forEach>
