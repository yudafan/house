                             ...
                             <div class="col-lg-12 col-md-12">
                                 <div class="submit-page form-simple">
                                     <div class="frm_submit_block">
                                         ...
                                         <div class="form-group col-md-6">
                                             <label>房子标题信息<a href="#" class="tip-topdata" data-tip="如合租-世界花园1-4居室-A卧"><i class="ti-help"></i> </a></label>
                                             <input type="text" name="title" class="form-control" value="${house.title}">
                                         </div>
                                             <div class="form-group col-md-8">
                                                 <label>房子详细地址信息<a href="#" class="tip-topdata" data-tip="广东省深圳市南山区世界之巅世纪花园小区99栋999室A卧"><i class="ti-help"></i> </a></label>
                                                 <input type="text" name="address" class="form-control" value="${house.address}">
                                             </div>
                                             <div class="form-group col-md-4">
                                                 <label>经纬度<a href="http://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">点击获取</a>
                                                     <a href="#" class="tip-topdata" data-tip="经纬度，如113.123456.65432223456"><i class="ti-help"></i> </a></label>
                                     ...
                                     <div class="frm_submit_block">
                                         ...
                                         <div class="form-row">
                                             ...
                                             <div class="form-group col-md-6">
                                                 <label>面积<a href="#" class="tip-topdata" data-tip="整租类型时为整个房子的面积，合租类型时为单间面积"><i class="ti-help"></i> </a></label>
...
<script>
    $(function (){
        ...
        $("#file").fileinput({
            language:'zh',
            uploadUrl:"/file/upload?key="+timestamp,
